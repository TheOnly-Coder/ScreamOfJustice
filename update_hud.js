...
const settingsBtnStr = `          {/* Action buttons (Mute/Quit) */}
...
const newSettingsBtnStr = `          {/* Action buttons (Mute/Quit) */}
          <div className="flex items-center gap-2 pointer-events-auto">
            <button`;

code = code.replace(settingsBtnStr, newSettingsBtnStr);
fs.writeFileSync('src/components/GameHUD.tsx', code);
console.log("Removed settings button from HUD");
